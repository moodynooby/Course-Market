...
/**
 * Retrieves a user's API key for a specific provider.
 * Follows data minimization by only selecting the apiKey column.
 * Filters by both auth0UserId and provider at the database level for security and efficiency.
 */
