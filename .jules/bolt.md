...
## 2026-05-21 - Scheduling Engine Hot Path Optimization
**Learning:** Re-calculating time minutes and performing Set lookups in high-frequency loops (conflict checks, feature scoring) is a major bottleneck. WeakMap-based caching of TimeSlot calculations and bitmask-based day membership checks provide significant speedups without sacrificing object immutability or readability.
**Action:** Use WeakMap to associate heavy calculations with data objects and bitmasks for membership checks in tight combinatorial loops.
