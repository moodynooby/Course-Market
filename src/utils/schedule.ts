...
const MAX_TIME_CACHE = 1440; // Full 24-hour coverage

/**
 * Converts HH:mm string to minutes from midnight.
 * Optimized with manual parsing and capped Map cache.
 */
 ...
 * Uses WeakMap to avoid redundant parsing and Map lookups.
 */
