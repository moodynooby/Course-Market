...
/**
 * High-performance time parsing that avoids array allocations.
 * HH:mm strings have a very limited set of possible values, so no eviction is needed.
 */
...
/**
 * Retrieves pre-calculated start and end minutes for a TimeSlot object.
