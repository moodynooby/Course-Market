...
/**
 * Returns pre-calculated minutes for a TimeSlot, using a WeakMap to cache
 * results for object identity. This avoids redundant string parsing in
 * performance-critical loops like conflict detection and scoring.
 */
