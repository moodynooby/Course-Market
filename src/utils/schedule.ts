...
const MAX_CACHE_SIZE = 1440; // Max possible minutes in a day
...
/**
 * Retrieves pre-calculated numeric minutes for a TimeSlot.
 * Uses a WeakMap to cache results for the lifetime of the TimeSlot object.
 */
