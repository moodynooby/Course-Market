...
/** 1440 minutes in a day, covering all possible HH:mm values */
...
/**
 * Returns numeric start/end minutes for a TimeSlot, using a WeakMap to cache
 * the results at the object level. This avoids redundant string parsing
 * during tight schedule generation/scoring loops.
 */
